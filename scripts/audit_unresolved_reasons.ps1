...
Write-Host "Auditing current UNRESOLVED states using aggregate counts only..."
$sql | ssh -T `
    -o ConnectTimeout=10 `
...
if ($LASTEXITCODE -ne 0) {
    throw "Could not read aggregate unresolved diagnostics from the central database."
}
