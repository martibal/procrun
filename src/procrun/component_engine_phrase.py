...
RULES: tuple[ComponentRule, ...] = (
    ...
    ComponentRule(
        ...
        "valves",
        "Valves",
        ("válvulas", "valvulas", "valves", "valvole"),
        ("42131",),
    ),
    ComponentRule(
        ComponentDomain.WATER_WASTEWATER,
    ...
    ComponentRule(
        ...
        "dredging",
        "Dredging",
        ("dragagem", "dragagens", "dredging", "dragaggio", "dragaggi"),
        ("45244",),
    ),
    ComponentRule(
        ComponentDomain.PORTS_COASTAL,
    ...
    ComponentRule(
        ...
        "civil_works",
        "Civil works",
        ("obras civis", "civil works", "opere civili", "lavori civili"),
        ("45", "452"),
    ),
    ComponentRule(
        ComponentDomain.RESILIENCE_FIRE,
