export default function AccountPage() {
  return <>
    ...
    <div className="grid">
      <div className="card"><div className="small">Plan</div><div className="kpi" style={{fontSize:22}}>ProcRun Portugal</div><p className="small">€149/month launch package</p></div>
      <div className="card"><div className="small">Checkout</div><div className="kpi" style={{fontSize:22}}>Disabled</div><p className="small">Requires A19 and green CI.</p></div>
