...
export default async function RunwayPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return <>
    ...
    <div className="grid">
      ...
      <div className="card"><div className="small">Classified projects</div><div className="kpi">{(projectState("OPEN") + projectState("CLOSED") + projectState("PARTIAL")).toLocaleString("en-US")}</div><div className="micro">Projects where at least one purchasing need could be identified and assessed</div></div>
      <div className="card"><div className="small">Needs review</div><div className="kpi">{projectState("UNRESOLVED").toLocaleString("en-US")}</div><div className="micro">Projects where the published wording is not specific enough for a reliable status</div></div>
    </div>
    ...
    <section className="section runway-section">
      ...
      <p className="small">Use the filters to narrow the list by status, purchasing need, location or funding. The exact project wording is always shown separately from ProcRun's assessment.</p>
      ...
      <div className="status-guide" aria-label="Status definitions">
        ...
        <div><strong>UNRESOLVED</strong><span>The published wording is not specific enough to decide reliably whether a purchasing need is Open or Closed. The source text is shown for review.</span></div>
