export default function ProfilePage() {
  return <>
    ...
    <div className="source-cards">
      <article className="field"><strong>Product categories</strong><div className="checkset"><span className="check">Equipment</span><span className="check">Systems</span><span className="check">Infrastructure works</span><span className="check">Technical services</span></div></article>
      <article className="field"><strong>CPV families</strong><label className="small" htmlFor="cpv">Optional category filter</label><select id="cpv" defaultValue="equipment"><option value="equipment">Equipment & systems</option><option value="works">Infrastructure works</option><option value="services">Technical services</option></select></article>
      <article className="field"><strong>Geography</strong><label className="small" htmlFor="geo">Launch market</label><select id="geo" defaultValue="lombardia"><option value="lombardia">Lombardia</option></select></article>
      <article className="field"><strong>Project value</strong><label className="small" htmlFor="value">Optional preferred value range</label><select id="value" defaultValue="any"><option value="any">Any</option><option value="1m">€1m+</option><option value="5m">€5m+</option><option value="10m">€10m+</option></select></article>
    </div>
