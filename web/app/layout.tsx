...
export const metadata: Metadata = {
  title: { default: "ProcRun — funded-project procurement evidence", template: "%s | ProcRun" },
  description: "Evidence-bounded funded-project procurement intelligence with exact source wording, TED procurement evidence and explicit OPEN/CLOSED/UNRESOLVED interpretation.",
};
